  ...
  return (
    <div className="md:hidden">
      <Dialog>
        ...
        <DialogContent className="md:hidden absolute  bg-transparent text-black flex max-w-full h-screen p-0">
          <div className="w-1/2 bg-transparent cursor-pointer"></div>

          <div className="w-1/2 bg-white rounded-l-sm p-6">
            ...
            <Button className="flex mt-40 gap-4 w-full text-base text-white  border-indigo-500 rounded-full hover:shadow-xl">
              <span>
                <Download />
              </span>
