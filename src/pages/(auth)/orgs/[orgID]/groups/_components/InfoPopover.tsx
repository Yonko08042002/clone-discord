...
export default function InfoPopover({ member }: Props) {
  return (
    <div className="flex flex-col gap-12 bg-primary-foreground rounded-md">
      <div className="relative bg-blue-900 h-16 rounded-t-md">
        <div className=" absolute top-3 left-3 bg-primary-foreground p-2 w-24 h-24 rounded-full">
          <img
            src={member.avatar}
            alt={member.name}
      ...
      <div className="w-full h-full p-4">
        <div className="w-full h-full bg-primary/10 rounded-sm p-2">
          ...
          <div className="flex gap-2">
            ...
            <p className="flex items-center text-sm gap-1">
              <p className="bg-primary/20 text-xs px-1 rounded-full">D</p>
              05/11/2023
            </p>
          </div>
          <div className="mt-3">
            ...
            <div className="flex gap-2">
              <div className="flex items-center gap-x-1 bg-primary/20 px-1 rounded-sm">
